...
class WorldMap {
    ...
    populateMap(monsters) {
        ...
        // TODO: is there a way of using this event loop hack to get the rest of the program to run properly afterwards?
        // let splitStackCounter = 0;
        // (function placeMonster(monster){
        //     ++splitStackCounter;
        //     const isIntervalOfThousand = !(splitStackCounter % 1000);
        //
        //     if(citiesFilled < numberOfCities) {
        //
        //         if (monsters.length === 0 && citiesFilled === self.originalMonsters.length) {
